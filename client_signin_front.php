...
if(isset($_POST['forgetpass'])){
    header("Location: pass_reset1.php");
    exit();
}
?>
...
<head>
    ...
    <style>
        ...
        .buttonn,.button,input[type="submit"] {
...
<div class="container">
    ...
    <form action="signin_back.php" method="POST">
        ...
        <input type="submit" name="trainer" value="trainer" class="buttonn">
        <input type="submit" name="forgetpass" value="Forget Password" class="buttonn">
